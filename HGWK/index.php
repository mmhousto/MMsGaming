...
<html lang="en-us">
  <head>
    ...
    <script>
      var gameInstance = UnityLoader.instantiate("gameContainer", "Build/HGWK.json", {onProgress: UnityProgress});
    </script>
...
<br>
    ...
    <div class="webgl-content" style="height: 100vh; margin-top: 175px">
        <br><br><br><br><br>
...
<footer id="gradient" class="footer2">
